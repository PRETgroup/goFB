 ...
 */
int VVI_LRI_preinit(VVI_LRI_t _SPM *me) {
 ...
 */
int VVI_LRI_init(VVI_LRI_t _SPM *me) {
...
void VVI_LRI_LRI_Set_Timeout_Value(VVI_LRI_t _SPM *me) {
 ...
 */
void VVI_LRI_run(VVI_LRI_t _SPM *me) {
	//if there are output events, reset them
