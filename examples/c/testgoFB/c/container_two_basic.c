...
// This file represents the implementation of the Composite Function Block for container_two_basic
#include "container_two_basic.h"
...
/* container_two_basic_preinit() is required to be called to 
 * initialise an instance of container_two_basic. 
...
/* container_two_basic_init() is required to be called to 
 * set up an instance of container_two_basic. 
...
/* container_two_basic_syncOutputEvents() synchronises the output events of an
...
/* container_two_basic_syncOutputData() synchronises the output data connections of an
 * instance of container_two_basic as required by synchronous semantics.
...
/* container_two_basic_syncInputData() synchronises the input data connections of an
 * instance of container_two_basic as required by synchronous semantics.
 * It does the checking to ensure that only connections which have had their
 * associated event fire are updated.
 * Notice that it does NOT perform any computation - this occurs in the
...
/* container_two_basic_run() executes a single tick of an
 * instance of container_two_basic according to synchronise semantics.
