...
repeat: 	//when we have had a mid-tick transition, we want to start the run again 
	...
	if(me->_trigger == false) {
		...
		case STATE_ha_otherthing_Start:
			if(true) {
				...
				me->_state = STATE_ha_otherthing_State1E0;
				me->_trigger = true;
			};
			break;
		case STATE_ha_otherthing_State1E0:
	...
	if(me->_trigger == true) {
		...
		case STATE_ha_otherthing_State1E0:
			...
			ha_otherthing_yPrimeEq0(me, ha_otherthing_yDotEq2Trig6_ode_f, ha_otherthing_yDotEq2Trig6_ode_g);
