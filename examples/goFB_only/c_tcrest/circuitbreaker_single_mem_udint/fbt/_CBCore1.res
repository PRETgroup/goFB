...
<ResourceType Name="_CBCore1" Comment="" >
...
<FBNetwork>
  ...
  <EventConnections><Connection Source="cb.b_change" Destination="msgh.MessageChanged" />
<Connection Source="cb.b_change" Destination="led.i_change" />
<Connection Source="msgh.TxDataPresent" Destination="tx.DataPresent" />
<Connection Source="tx.SuccessChanged" Destination="msgh.TxSuccessChanged" />
<Connection Source="timer.Tick" Destination="cb.tick" />
...
<Connection Source="amm.i_measured" Destination="cb.i_measured" /></EventConnections>
  <DataConnections><Connection Source="cb.b" Destination="msgh.Message" />
<Connection Source="cb.b" Destination="led.i" />
<Connection Source="msgh.TxData" Destination="tx.Data" />
<Connection Source="tx.Success" Destination="msgh.TxSuccess" />
<Connection Source="hmi.i_set" Destination="cb.i_set" />
<Connection Source="amm.i" Destination="cb.i" /></DataConnections>
</FBNetwork>
</ResourceType>