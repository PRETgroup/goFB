...
// This file represents the implementation of the Composite Function Block for _CBCore3
...
/* _CBCore3_preinit() is required to be called to 
 * initialise an instance of _CBCore3. 
 * It sets all I/O values to zero.
 */
int _CBCore3_preinit(_CBCore3_t _SPM  *me) {
...
/* _CBCore3_init() is required to be called to 
 * set up an instance of _CBCore3. 
 * It passes around configuration data.
 */
int _CBCore3_init(_CBCore3_t _SPM  *me) {
...
/* _CBCore3_syncOutputEvents() synchronises the output events of an
 * instance of _CBCore3 as required by synchronous semantics.
 * Notice that it does NOT perform any computation - this occurs in the
 * _run function.
 */
void _CBCore3_syncOutputEvents(_CBCore3_t _SPM  *me) {
...
/* _CBCore3_syncInputEvents() synchronises the input events of an
 * instance of _CBCore3 as required by synchronous semantics.
 * Notice that it does NOT perform any computation - this occurs in the
 * _run function.
 */
void _CBCore3_syncInputEvents(_CBCore3_t _SPM  *me) {
...
/* _CBCore3_syncOutputData() synchronises the output data connections of an
 * instance of _CBCore3 as required by synchronous semantics.
 ...
 * _run function.
 */
void _CBCore3_syncOutputData(_CBCore3_t _SPM  *me) {
...
/* _CBCore3_syncInputData() synchronises the input data connections of an
 * instance of _CBCore3 as required by synchronous semantics.
 * It does the checking to ensure that only connections which have had their
 * associated event fire are updated.
 * Notice that it does NOT perform any computation - this occurs in the
 * _run function.
 */
void _CBCore3_syncInputData(_CBCore3_t _SPM  *me) {
...
/* _CBCore3_run() executes a single tick of an
 * instance of _CBCore3 according to synchronise semantics.
 * Notice that it does NOT perform any I/O - synchronisation
 * is done using the _syncX functions at this (and any higher) level.
 */
void _CBCore3_run(_CBCore3_t _SPM  *me) {
