...
void task0(_CBCore0_t * c0);
void task1(_CBCore1_t * c1);
void task2(_CBCore2_t * c2);
void task3(_CBCore3_t * c3);


int main() {
	printf("circuitbreaker_mem tcrest4 startup.\n");
...
void __attribute__ ((noinline)) timed_task0(_CBCore0_t * c0) {
...
void __attribute__ ((noinline)) timed_task1(_CBCore1_t * c1) {
...
void __attribute__ ((noinline)) timed_task2(_CBCore2_t * c2) {
...
void __attribute__ ((noinline)) timed_task3(_CBCore3_t * c3) {
