 ...
 */
int InjectorMotorController_preinit(InjectorMotorController_t _SPM *me) {
 ...
 */
int InjectorMotorController_init(InjectorMotorController_t _SPM *me) {
...
void InjectorMotorController_SetArmDownPosition(InjectorMotorController_t _SPM *me) {
me->InjectorPosition = 255;
//printf("Injector: Set Injector Arm to Down position\n");
}

void InjectorMotorController_SetArmUpPosition(InjectorMotorController_t _SPM *me) {
//printf("Injector: Set injector arm to up position\n");
me->InjectorPosition = 0;

}

void InjectorMotorController_Algorithm1(InjectorMotorController_t _SPM *me) {
//printf("lalalala\n");
}
 ...
 */
void InjectorMotorController_run(InjectorMotorController_t _SPM *me) {
	//if there are output events, reset them
