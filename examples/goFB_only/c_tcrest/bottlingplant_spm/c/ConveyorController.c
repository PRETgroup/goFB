 ...
 */
int ConveyorController_preinit(ConveyorController_t _SPM *me) {
 ...
 */
int ConveyorController_init(ConveyorController_t _SPM *me) {
...
void ConveyorController_ConveyorStart(ConveyorController_t _SPM *me) {
me->ConveyorSpeed = 1;
//printf("Conveyor: Start\n");
}

void ConveyorController_ConveyorStop(ConveyorController_t _SPM *me) {
me->ConveyorSpeed = 0;
//printf("Conveyor: Stop\n");
}

void ConveyorController_ConveyorRunning(ConveyorController_t _SPM *me) {
///printf("Conveyor running region\n");
}

void ConveyorController_ConveyorEStop(ConveyorController_t _SPM *me) {
 ...
 */
void ConveyorController_run(ConveyorController_t _SPM *me) {
	//if there are output events, reset them
