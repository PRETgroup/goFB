...
<FBNetwork>
  ...
  <FB Name="switches" Type="Switches" x="175" y="1006.25" />
  <EventConnections><Connection Source="tx.SuccessChanged" Destination="prod.TxSuccessChanged" />
<Connection Source="prod.DataPresent" Destination="tx.DataPresent" />
<Connection Source="switches.DataChanged" Destination="prod.DataInChanged" /></EventConnections>
  <DataConnections><Connection Source="TxChanId" Destination="tx.ChanId" />
<Connection Source="tx.Success" Destination="prod.TxSuccess" />
<Connection Source="prod.Data" Destination="tx.Data" />
<Connection Source="switches.Data" Destination="prod.DataIn" /></DataConnections>
</FBNetwork>
</ResourceType>