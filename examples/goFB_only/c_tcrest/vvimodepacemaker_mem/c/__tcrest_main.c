...
int main() {
	printf("vvi mode pacemaker tcrest4 startup.\n");
	printf("sizes: %lu, %lu, %lu, %lu\n", sizeof(FakePacemakerTop_t)*PROGS_PER_CORE, sizeof(FakePacemakerTop_t)*PROGS_PER_CORE, sizeof(FakePacemakerTop_t)*PROGS_PER_CORE, sizeof(FakePacemakerTop_t)*PROGS_PER_CORE);
	mp_init();
	printf("Starting t1,t2,t3 and initialising FakePacemakerTop_t...\n");
