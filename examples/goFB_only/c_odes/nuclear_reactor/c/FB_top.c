...
void top_syncInputEvents(top_t  *me) {
	...
	me->p.inputEvents.event.add1 = me->c.outputEvents.event.add1; 
	
	me->p.inputEvents.event.add2 = me->c.outputEvents.event.add2; 
	
	me->p.inputEvents.event.remove1 = me->c.outputEvents.event.remove1; 
	
	me->p.inputEvents.event.remove2 = me->c.outputEvents.event.remove2; 
