{{define "compositeFB_eventMoC"}}// This file has been automatically generated by goFB and should not be edited by hand
...
//When running a composite block under event MoC, note that you would call the functions in this order (and this is very important)
//_preinit(); 
//_init();
//do {
//	_run();
 ...
 * _run function.
 */
void {{$block.Name}}_syncOutputEvents({{$block.Name}}_t *me) {
 ...
 * _run function.
 */
void {{$block.Name}}_syncInputEvents({{$block.Name}}_t *me) {
 ...
 * _run function.
 */
void {{$block.Name}}_syncOutputData({{$block.Name}}_t *me) {
 ...
 * _run function.
 */
void {{$block.Name}}_syncInputData({{$block.Name}}_t *me) {
