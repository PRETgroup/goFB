...
entity enforcer_WaterBoilerEnforcer_P1 is
    port
    (
        clk         : in std_logic;
        reset       : in std_logic;
...
architecture behaviour of enforcer_WaterBoilerEnforcer_P1 is
...
begin
    ...
    begin
        if(rising_edge(clk)) then
            ...
            if((trigger_Top = '1') and not((q_enf.Vop = to_unsigned(255, 8))) and (t > (to_unsigned(10000000, 64) + trigger_Top_time)) ) then
                e <= '1';
                --recover
                q_enf.Vop := to_unsigned(255, 8);
            ...
            if(trigger_Top = '1' and ((q_enf.Pboiler < to_unsigned(100, 8)))) then
                trigger_Top <= '0';
            end if;
